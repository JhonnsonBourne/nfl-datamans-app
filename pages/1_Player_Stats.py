...
from utils import (
    ...
    load_dataset_cached,
    _first_present,
    _compute_fantasy_points,
    _compute_shares_and_adv_metrics,
    _present_filters,
)

st.set_page_config(page_title="Player Stats - NFL Data Explorer", layout="wide")
...
def _render_player_stats(df: pd.DataFrame, module_name: str, seasons: List[int]):
    ...
    with st.expander("Filters", expanded=True):
        ...
        if opp_col and opp_col in df.columns and df[opp_col].notna().any():
